...
JSON decycle replaces circular references with `{"$ref": PATH}` (where PATH is the [JSONPath](https://goessner.net/articles/JsonPath/) that locates the first occurrence).
